 ...
 * Must NOT be called inside createWindow to avoid duplicate registration on macOS.
 */
function registerIpcHandlers(): void {
  ...
  // File picker handler (uses mainWindow reference)
...
app.on('ready', () => {
  ...
  database.getDb();
  // Register IPC handlers once (before any window creation)
  registerIpcHandlers();
  createWindow();
});
